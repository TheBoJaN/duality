...
{
    /// <summary>
    /// Provides math utility methods and double versions of <see cref="System.MathD"/> to fit
    /// </summary>
    public static class MathD
    {
        ...
        {
            return MathD.RoundToInt(a + ratio * (double)(b - a));
        }
        ...
        {
            val1 = MathD.NormalizeVar(val1, minVal, maxVal);
            val2 = MathD.NormalizeVar(val2, minVal, maxVal);
        ...
        {
            val1 = MathD.NormalizeAngle(val1);
            val2 = MathD.NormalizeAngle(val2);
            if (val1 == val2) return 0.0f;
        ...
        public static void TransformCoord(ref double xCoord, ref double yCoord, double rot, double scale, double xCenter, double yCenter)
        {
        ...
        public static void GetTransformDotVec(double rot, Vector2D scale, out Vector2D xDot, out Vector2D yDot)
        {
            double sin = (double)System.Math.Sin(rot);
            double cos = (double)System.Math.Cos(rot);
            xDot = new Vector2D(cos * scale.X, -sin * scale.X);
            yDot = new Vector2D(sin * scale.Y, cos * scale.Y);
        }
        /// <summary>
        /// Prepares a 2d transformation (rotation and scale).
        /// </summary>
        ...
        /// <param name="xDot">Dot product base for the transformed x value.</param>
        /// <param name="yDot">Dot product base for the transformed y value.</param>
        public static void GetTransformDotVec(double rot, double scale, out Vector2D xDot, out Vector2D yDot)
        {
            double sin = (double)System.Math.Sin(rot);
            double cos = (double)System.Math.Cos(rot);
            xDot = new Vector2D(cos * scale, -sin * scale);
            yDot = new Vector2D(sin * scale, cos * scale);
        }
        /// <summary>
        ...
        /// <param name="xDot">Dot product base for the transformed x value.</param>
        /// <param name="yDot">Dot product base for the transformed y value.</param>
        /// <seealso cref="TransformDotVec(ref Vector2D, ref Vector2D, ref Vector2D)"/>
        public static void GetTransformDotVec(double rot, out Vector2D xDot, out Vector2D yDot)
        {
            double sin = (double)System.Math.Sin(rot);
            double cos = (double)System.Math.Cos(rot);
            xDot = new Vector2D(cos, -sin);
        ...
        /// <seealso cref="GetTransformDotVec(double, out Vector2D, out Vector2D)"/>
        public static Vector2D TransformDotVec(Vector2D vec, Vector2D xDot, Vector2D yDot)
        {
            return new Vector2D(
        ...
        /// <returns>The transformed vector.</returns>
        /// <seealso cref="GetTransformDotVec(double, out Vector2D, out Vector2D)"/>
        public static Vector3D TransformDotVec(Vector3D vec, Vector2D xDot, Vector2D yDot)
        {
            return new Vector3D(
                vec.X * xDot.X + vec.Y * xDot.Y,
                vec.X * yDot.X + vec.Y * yDot.Y,
        ...
        public static Vector2D PointLineNearestPoint(
            double pX, double pY,
            double lX1, double lY1, double lX2, double lY2,
            bool infinite = false)
        {
            if (lX1 == lX2 && lY1 == lY2) return new Vector2D(lX1, lY1);
            double sX = lX2 - lX1;
            double sY = lY2 - lY1;
            ...
            return new Vector2D((double)((1.0d - q) * lX1 + q * lX2), (double)((1.0d - q) * lY1 + q * lY2));
        }
        ...
        public static double PointLineDistance(
            ...
            bool infinite = false)
        {
            Vector2D n = PointLineNearestPoint(pX, pY, lX1, lY1, lX2, lY2, infinite);
        ...
        /// <returns></returns>
        public static bool IsPolygonConvex(params Vector2D[] vertices)
        {
            bool neg = false;
            bool pos = false;
            ...
            for (int a = 0; a < vertices.Length; a++)
            {
                ...
                Vector2D ab = vertices[b] - vertices[a];
                Vector2D bc = vertices[c] - vertices[b];

                if (ab == Vector2D.Zero) return false;
                if (bc == Vector2D.Zero) return false;

                double dot_product = Vector2D.Dot(ab.PerpendicularLeft, bc);
        ...
        /// </summary>
        /// <param name="value"></param>
        public static void CheckValidValue(Vector2D value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public static void CheckValidValue(Vector3D value)
        {
            if (double.IsNaN(value.X) || double.IsInfinity(value.X) ||
                double.IsNaN(value.Y) || double.IsInfinity(value.Y) ||
