...
namespace FarseerPhysics.Common.Decomposition
{
	...
	{
		private static Vector2D _tmpA;
		private static Vector2D _tmpB;
		private static Vector2D _tmpC;
		...
		private static bool InsideTriangle(ref Vector2D a, ref Vector2D b, ref Vector2D c, ref Vector2D p)
		{
			//A cross bp
